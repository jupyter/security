...
Using Let's Encrypt
*******************
`Let's Encrypt`_ is a nonprofit service that provides free SSL/TLS certificates through a global certificate authority (CA).  
...
Encrypting your security reports is encouraged but not required.  If you’d like to encrypt your message,
